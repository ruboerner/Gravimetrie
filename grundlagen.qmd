...
## Das Schwerepotential und seine Ableitungen
...
Raumpunkte it gleichem Potentialwert liegen auf Äquipotentialflächen (Niveauflächen ($W_{1},W_{2},W_{3}$). 
...
### Herleitung Schwerepotential im rotierenden System
...
Für die Zentrifugalbeschleunigung $\mathbf{a}_{Z}$ gilt
$$
\mathbf{a}_{Z} = (\pmb\omega_{E}\times {\mathbf{R}}_{1}) \times \pmb\omega_{E} = \omega_{E}^{2} \mathbf{R}_{1}
-(\pmb\omega_{E} \cdot \mathbf{R}_{1})\pmb\omega_{E} = \omega_{E}^{2}\mathbf{R}_{\perp}
$$
