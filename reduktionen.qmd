...
- vom Ort des Beobachtungspunktes (geographische Breite $\varphi$ und Höhe $h$) __$\to$ Reduktionen__
- von sichtbaren Masseninhomogenitäten (Topographie) __$\to$ Reduktionen__
...
![Bouguer-Schwereanomalie Sachsen](images/Gravimetrie_Uebersichtskarte.png)
...
Beseitigung aller zeitabhängigen Schwankungen im Messwert durch wiederholtes Anmessen einer Basisstation im Punkt $(x_{0}, y_{0}, z_{0})$:
$$
\Delta g(x,y,z) = g(x,y,z,t) - g(x_{0}, y_{0}, z_{0}, t)
$$
...
Die so erhaltenen Schwerewerte sind nach Anwendung der Korrekturen nur noch vom Ort abhängig.
Die vorliegende relative Schwere ist von Dichteunterschieden in der Erde abhängig, wobei die Erde selbst als massebehaftetes Objekt auf die Schwere wirkt, ebenso wie kleinskalige Dichtekontraste geologischer Körper.
...
Die Normalschwere nimmt bei $\varphi = 50^\circ$ auf einem Profil nach Norden um 0.8 mGal/km zu.
...
In mittleren Breiten mit $\varphi \approx 50 ^\circ$ erhalten wir für $\Delta\gamma$
