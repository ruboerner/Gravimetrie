...
display(HTML(rf"\( \Delta \gamma \) = {expr:.3f} mGal"))
```

Ein Lagefehler von 10 m verursacht also einen Reduktionsfehler von 0.008 mGal.

Andererseits erkennen wir, dass sich bei Bewegung des Messpunktes um 1 km nach Norden die Normalschwere in mittleren Breiten um 0.8 mGal erhöht.
:::
